...
import { FiLogOut, FiBriefcase, FiSettings } from 'react-icons/fi';
...
const CompanyHeader: React.FC = () => {
    ...
    return (
        <header className="flex-shrink-0 bg-white dark:bg-brand-dark-200 shadow-sm p-4 flex justify-end items-center z-10 border-b border-gray-200 dark:border-gray-700">
