                    ...
                    <AnimatePresence>
                        {isProfileMenuOpen && (
                            ...
                            >
                                ...
                                <div className="py-1">
                                    <Link to="/donor/profile" onClick={() => setIsProfileMenuOpen(false)} className="flex items-center w-full text-left px-4 py-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-brand-dark" role="menuitem">
                                        <FiUser className="mr-3"/> My Profile
                                    </Link>
                                    <Link to="/donor/settings" onClick={() => setIsProfileMenuOpen(false)} className="flex items-center w-full text-left px-4 py-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-brand-dark" role="menuitem">
