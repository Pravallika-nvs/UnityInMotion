...
const Contact: React.FC = () => {
    ...
    const inputStyles =
        "block w-full px-3 py-2 bg-background border border-border rounded-md shadow-sm focus:outline-none focus:ring-primary focus:border-primary sm:text-sm";
        ...
        <div className="bg-background">
            ...
            <div className="max-w-7xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:px-8">
                ...
                <div className="text-center">
                    ...
                    <h1 className="text-4xl font-bold font-display text-text-primary sm:text-5xl">
                        Get in Touch
                    </h1>
                    ...
                    <div className="mt-12 lg:mt-0">
                        ...
                        <div className="space-y-4 text-lg text-text-secondary">
                            ...
                            <p className="flex items-center">
                                ...
                                123 Charity Lane, Hope City, 12345
                        ...
                        <div className="mt-8 h-80 rounded-lg overflow-hidden shadow-lg border border-border">
                            ...
                            <iframe
                                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3153.085819586144!2d-122.41941548468155!3d37.77492957975871!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8085808c1e8433c%3A0x1c3132e1b12b5f6a!2sSan%20Francisco%20City%20Hall!5e0!3m2!1sen!2sus!4v1626359148536!5m2!1sen!2sus"
                                width="100%"
                                height="100%"
                                style={{ border: 0 }}
